  ...
  return (
    <div className="min-h-view py-40">
      ...
      <div className="flex flex-col items-center text-center py-10">
        ...
        <div className="flex items-center font-bold text-5xl py-6">
          <span className="inline-block leading-[1.3] pb-1 animate-text-gradient bg-gradient-to-r from-[#b2a8fd] via-secondary to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-7xl text-transparent">
        ...
        <div className="max-w-xl mx-auto flex items-center justify-between gap-4 py-6">
          <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50">
            ...
            <span className="inline-flex z-0 h-full w-full cursor-pointer items-center justify-center rounded-full bg-gray-950 px-8 py-1 text-xl font-medium text-secondary backdrop-blur-3xl">
              See my work
            </span>
          </button>
          <button className="inline-flex h-12 items-center justify-center rounded-md text-xl border border-gray-800 bg-gradient-to-t from-[#8678f9] from-0% to-[#c7d2fe] px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50 ">
            Download CV
          </button>
        </div>
      </div>
