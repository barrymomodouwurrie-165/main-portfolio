    ...
    <div className="max-w-5xl mx-auto px-2 py-6">
      ...
      <div className="flex flex-col gap-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_1fr] gap-4">
          <div className="md:max-w-[500px] flex flex-col border  border-orange-600/20 hover:shadow-[0_0_20px_rgba(210,187,255,0.15)] transition-shadow duration-300 p-6  rounded-lg bg-secondary/10 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4">
          <div className="flex flex-col border  border-orange-600/20 hover:shadow-[0_0_20px_rgba(210,187,255,0.15)] transition-shadow duration-300 p-6  rounded-lg bg-secondary/10 ">
            <div className="flex items-start justify-between">
          ...
          <div className="flex items-center justify-between border border-orange-600/20 p-6 rounded-lg bg-secondary/10 hover:shadow-[0_0_20px_rgba(210,187,255,0.15)] transition-shadow duration-30 ">
              <div className=" flex flex-col gap-4 mt-6">
